...
function App() {
  ...
  const navigationItems = ['Home', 'Family', 'Stories', 'Gallery', 'Michael', 'Contact']
  ...
  return (
    <div className="mx-auto flex min-h-svh w-[calc(100%-3rem)] max-w-[1320px] flex-col max-[520px]:w-[calc(100%-2rem)]">
      <header className="relative flex min-h-[104px] items-center justify-between border-b border-line max-[820px]:min-h-[84px] max-[520px]:min-h-[75px]">
        <a className="inline-flex items-center gap-2.5 font-[Georgia,serif] text-2xl tracking-[-.06em] text-ink no-underline" href="#home" aria-label="Eligores home"><img className="size-[31px] object-contain" src={navIcon} alt="" /><span>eligores</span></a>
      ...
      <main id="home"><section className="grid flex-1 items-center gap-[clamp(48px,8vw,132px)] py-[clamp(64px,10vw,142px)] max-[820px]:gap-[52px] max-[820px]:pt-[76px] min-[821px]:grid-cols-[minmax(250px,.82fr)_minmax(520px,1.45fr)]" aria-labelledby="hero-title"><div className="max-w-[440px] max-[820px]:max-w-[540px]"><p className="mb-[22px] text-[11px] font-bold uppercase tracking-[.15em] text-accent">The Eligores family</p><h1 id="hero-title" className="font-[Georgia,serif] text-[clamp(43px,4.15vw,69px)] leading-[.98] font-normal tracking-[-.055em] text-ink">A place to keep the people and moments that matter close.</h1><p className="mt-[31px] max-w-[360px] text-base leading-[1.55] text-muted">Welcome to our corner of the internet—made with care, and growing with us.</p></div><FamilyGrid /></section></main>
